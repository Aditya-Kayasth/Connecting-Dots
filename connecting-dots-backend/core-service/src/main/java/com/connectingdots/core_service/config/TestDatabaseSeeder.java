    ...
    public void run(String... args) throws Exception {
        ...
        try {
            if (cloudinary.isPresent()) {
                System.out.println("[DATABASE SEEDER] Cloudinary client present — initiating media cleanup...");
                cloudinary.get().api().deleteResourcesByPrefix("connecting_dots/", Map.of());
            }
        } catch (Exception cEx) {
            System.out.println("[DATABASE SEEDER] Cloudinary cleanup note (non-fatal): " + cEx.getMessage());
        }
        ...
        // Application 2: Ananya Joshi applying to P2 (Accessible Job Portal) -> ACCEPTED
        ...
        // Application 3: Aarav Deshmukh applying to P3 (Vidarbha Farmers Mandi Alerts) -> ACCEPTED
        ...
        // Application 5: Priya Kulkarni applying to P8 (AI Marathi Summarizer) -> COMPLETED
        ...
        // ----------------------------------------------------------------------
        // Chat Journey for App 1 (Handpump Alert): Rohan Patil & Marathwada Jal Vikas Foundation
        ...
        // Chat Journey for App 2 (Accessible Job Portal): Ananya Joshi & Netra Vikas Society
        ...
        System.out.println("=================================================");
        System.out.println("[DATABASE SEEDER COMPLETE] All Maharashtra NGOs, Problems, Contributors, Applications, Chat Messages, and Reviews are active!");
        System.out.println("=================================================");
    }
}
